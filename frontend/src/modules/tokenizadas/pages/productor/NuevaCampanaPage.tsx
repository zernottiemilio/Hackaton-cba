...
export function NuevaCampanaPage() {
   ...
   * una campaña que se puede comprar ya y liquidar a los 3 minutos.
   */
  const armarCampanaDePrueba = () => {
    ...
    toast.success('Campaña de prueba armada', { description: 'Venta 2 min · liquidable a los 3 min. Solo falta firmar.' });
  };
